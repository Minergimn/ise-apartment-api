# Ozon Marketplace Apartment API
...
```sh
[I] ➜ grpc_cli call localhost:8082 DescribeApartmentV1 "id: 1"
connecting to localhost:8082
Rpc failed with status code 5, error message: Apartment not found
```
...
```sh
[I] ➜ curl -s -X 'POST' \
  'http://localhost:8080/v1/apartments' \
...
```sh
$ pgcli "postgresql://docker:docker@localhost:5432/ise_apartment_api"
```
